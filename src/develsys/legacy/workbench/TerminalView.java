 ...
 * @author hmariod
 */
public class TerminalView extends AnchorPane{
    ...
    public void load(){
        ...
        tabPane.getTabs().addAll(tabTerminal);
            ...
            public void changed(ObservableValue ov, Object t, Object t1) {
                try{
                    if(!cmbSelectComm.getSelectionModel().isEmpty()){
                        CommCmbItem commCmbItem = (CommCmbItem) ov.getValue();
    ...
    private void getPorts(){
        ...
        while (portEnum.hasMoreElements()) {
            ...
            cmbSelectComm.getItems().add((new CommCmbItem(portName,currPortId)));
        }
                ...
                public void serialEvent(SerialPortEvent spe) {
                    if(spe.getEventType() == SerialPortEvent.DATA_AVAILABLE){
                        try{
                            ...
                            taCommIntput.appendText(new String(chunk));
                        }catch(Exception ex){
